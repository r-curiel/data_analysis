...
O script utiliza duas bases de dados CVM Resultados Financeiros e CVM Dados Cadastrais.
...
O objetivo foi observar a evolução das receitas de vendas e o lucro líquido no 1º ano dapandemia
...
Utilizaremos comandos das biblitecas tidyverse e readxl.

Comandos:
    glimpse; dim; head; names; options; unique; filter; group_by; arrange;
    ungroup; droplevels; as.numeric; mutate; distinct; count; select; 
    left_join; lag; summarise; n; mean; is.infinite; is.nan; if_else.
...
```{r}
dataset <- read_excel("C:/Users/curie/Desktop/datasets/cvm_result.xlsx")
```
...
```{r}
cadastro <- read_excel("C:/Users/curie/Desktop/datasets/cvm_data.xlsx")
```
