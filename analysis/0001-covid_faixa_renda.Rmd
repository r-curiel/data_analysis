...
Comandos:
    glimpse; dim; head; names; rename; mutate; recode; cut; 
    quantile; select; group_by; summarise; mean; sd; n; ungroup; 
    droplevels; right_join; ggplot; geom_col.
...
```{r}
dataset <- read.csv('C:/Users/curie/Desktop/datasets/covid.csv', 
                    header = TRUE, 
                    sep = ",", 
                    dec = ".")
```
...
```{r}
pib <- read_excel('C:/Users/curie/Desktop/datasets/wbd_income.xls')
```
